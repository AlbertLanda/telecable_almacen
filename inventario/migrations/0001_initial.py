# Generated by Django 4.2.11 on 2026-01-15 17:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('REQ_BORRADOR', 'REQ - Borrador'), ('REQ_PENDIENTE', 'REQ - Pendiente'), ('REQ_ATENDIDO', 'REQ - Atendido'), ('BORRADOR', 'Borrador'), ('CONFIRMADO', 'Confirmado'), ('ANULADO', 'Anulado')], default='REQ_BORRADOR', max_length=20)),
                ...
                ('recibido_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='documentos_recibidos', to=settings.AUTH_USER_MODEL)),
                ('responsable', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='documentos_inventario', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-fecha'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('costo_unitario', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text="Costo estándar por unidad (según 'unidad'). Ej: UND, M, CAJA.", max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creado_en', models.DateTimeField(auto_now_add=True)),
                ('actualizado_en', models.DateTimeField(auto_now=True)),
                ('rol', models.CharField(choices=[('SOLICITANTE', 'Solicitante'), ('ALMACEN', 'Almacén'), ('ADMIN', 'Administrador'), ('JEFA', 'Jefa / Global')], default='SOLICITANTE', max_length=15)),
                ('sede_activa', models.ForeignKey(blank=True, help_text='Sede actual seleccionada (para usuarios globales).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarios_activos', to='inventario.sede')),
                ('sede_principal', models.ForeignKey(blank=True, help_text='Sede fija del usuario (solicitante o almacén).', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='usuarios_principales', to='inventario.sede')),
